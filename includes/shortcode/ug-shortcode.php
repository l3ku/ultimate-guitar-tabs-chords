    ...
    public static function generate_shortcode( $attributes ) {
      ...
      if ( ! empty( $attributes ) ) {
        ...
        foreach ( $attributes as $key => $val ) {
          ...
          if ( in_array( $sanitized_key, self::$shortcode_whitelist, true )
    ...
    public function create_shortcode( $atts, $content, $html_strategy = 'table' ) {
      ...
      if ( ! shortcode_exists( 'ug-tabs-chords' ) ) {
        ...
        return new WP_Error(
          ...
          sprintf(
            /* translators: %s: The name of the shortcode */
      ...
      if ( 'table' === $html_strategy ) {
        ...
        return new WP_Error(
          ...
          sprintf(
            /* translators: %s: The shortcode output strategy (html-table, div...) */
